<?php
    ...
    class VentaSql{        
        ...
        public static function insertarVenta($venta){
            ...
            $sql = "INSERT INTO venta (nro_pedido, nombre, tipo, usuario, cantidad, fecha_venta, imagen) 
                    VALUES (:nro_pedido, :nombre, :tipo, :usuario, :cantidad, :fecha_venta, :imagen)";
        ...
        public static function VentaTipo($tipo){
            $pdo = AccesoDatos::dameAcceso();
            $sql = "SELECT * FROM venta WHERE tipo = :tipo";
        ...
        public static function ModificarVenta($nro_pedido, $usuario, $nombre, $tipo, $cantidad){
            $pdo = AccesoDatos::dameAcceso();
            $sql = "UPDATE venta SET usuario = :usuario, nombre = :nombre, tipo = :tipo, cantidad = :cantidad WHERE nro_pedido = :nro_pedido";
        ...
        public static function BorrarVenta($nro_pedido){
            $pdo = AccesoDatos::dameAcceso();
            $sql = "DELETE FROM venta WHERE nro_pedido = :nro_pedido";
