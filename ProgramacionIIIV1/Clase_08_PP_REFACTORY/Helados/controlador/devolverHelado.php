<?php
    ...
    if(isset($_POST['causa']) && isset($_POST['nroPedido'])){
        ...
        if($venta){
            ...
            $cupon = Cupon::AltaCupon(rand(200,10000),$devolucion->getId(),10,1);
            echo $cupon->getPorcentajeDescuento();
            Cupon::GuardarCupon($cupon);
            copy("ImagenesDeLaVenta/" . $venta->getImagen(), $carpeta."/" . $venta->getImagen());
