...
class Venta{
    ...
    public static function AltaVenta($mail,$sabor,$tipo,$cantidad,$imagen,$archivo){
        $obj = Helado::Buscador($sabor,$tipo,$archivo);
        if($obj){
            if($obj->getStock() >= $cantidad && $cantidad>0){
