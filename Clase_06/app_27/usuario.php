<?php
    class Usuario{
        ...
        public static function AltaUsuario($id,$nombre,$apellido,$clave,$mail,$fechaRegistro,$localidad){
            $usuario = null;
            if (is_int($id) && !empty($id) && is_string($nombre) && !empty($nombre)&& is_string($apellido) && !empty($apellido) && is_string($clave) && !empty($clave) && is_string($mail) && !empty($mail) && is_string($fechaRegistro) && !empty($fechaRegistro) && is_string($localidad) && !empty($localidad)) {
